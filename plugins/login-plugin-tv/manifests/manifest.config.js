      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            label_tooltip: "Text for “OK” Action button on the error overlay screen.",
            initial_value: "Ok",
            placeholder: "Ok"
          },
          {
...
function createManifest({ version, platform }) {
  ...
  const basePlatform = isTvos ? "tvos_for_quickbrick" : "android_tv_for_quickbrick";
  const assetsField = {
  ...
  baseManifest.custom_configuration_fields.push(assetsField);
